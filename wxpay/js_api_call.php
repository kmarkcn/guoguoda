<?php
session_start();
$money = $_SESSION['gguser_money'] / 100;
/**
 * JS_API支付demo
 * ====================================================
...
*/
	...
	$unifiedOrder->setParameter("total_fee","{$_SESSION['gguser_money']}");//总金额
    ...
    <div class="pay_prompt">
        ...
        <div class="pp_content">
            ...
            <div class="pp_ts_body">
                ...
                <div class="pp_btn_pay" onclick="callpay();">支付</div>
            </div>
        </div>
        ...
        <div class="pp_right"><span></span><!-- <img class="pp_logo" src="img/membercenter/logo.png" > -->
        	果果哒,最懂你的鲜果定制专家
        </div>
    </div>
