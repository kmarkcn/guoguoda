...
<?php if(!empty($normal_tips)): ?><p class="normal_tips"><b class="fa fa-info-circle"></b> <?php echo ($normal_tips); ?></p><?php endif; ?> 
      ...
      <div class="data-table">
        <div class="table-striped">
        	<div class="fl">
          <?php if(empty($model["extend"])): endif; ?>
        </div>
        	<br/><br/><br/><p style='font-size:20px;margin-bottom:50px;'>用户:<?php echo ($data["name"]); ?></p>
          <table cellspacing="1" style='width:400px;'>
            <!-- 表头 -->
            <thead>
              <tr>
               <th>订购时间</th><th>订购数量</th>
              </tr>
            </thead>
            
            <!-- 列表 -->
            <tbody>
					<?php if(is_array($data["list_data"])): $i = 0; $__LIST__ = $data["list_data"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						<td><?php echo ($vo["start_date"]); ?></td>
						<td><?php echo ($vo["quantity"]); ?>天</td>
