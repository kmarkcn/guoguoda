      ...
      <div class="data-table">
        <div class="table-striped">
          <table cellspacing="1">
            ...
            <thead>
              <tr>
               <th>用户名</th><th>体质</th><th>喜好</th><th>忌口</th><th>操作</th>
              </tr>
            </thead>
            ...
            <tbody>
					...
					<td><?php echo ($data["physic"]); ?></td>
					<td><?php echo ($data["like"]); ?></td>
					<td><?php echo ($data["dislike"]); ?></td>
					<td>
					<a href="./index.php?s=/addon/GuoGuoUser/GuoGuoUser/edit_hobby/type/show/userid/<?php echo ($userid); ?>.html">编辑 </a>
					</td>
					</tr>
            </tbody>
          </table>
